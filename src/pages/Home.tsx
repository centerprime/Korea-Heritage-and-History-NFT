...
import home_guide_001 from "../images/home_guide_001.png";
          ...
          <div className="col-lg-6">
             <div className="home_area_002">
                 ...
                 <div className="guide_box">
                     ...
                     <div className="guide_box_image" style={{backgroundImage: `url(${home_guide_001})`}}>
                     </div>
                     <p className="hackahtun_text_001">
                         01. First, connect your wallet with MetaMask. <br/>
                         02. We used  Kovan Test Network. </p>
                 </div>
             </div>
          </div>
      </div>
